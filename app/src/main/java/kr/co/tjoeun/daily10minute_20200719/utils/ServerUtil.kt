...
//        인증글에 댓글 남기는 기능
        ...
        fun postRequestReplyToProof(context: Context, proofId: Int, content:String, handler: JsonResponseHandler?) {
...
//        인증글 업로드 하기
        fun postRequestProof(context: Context, projectId: Int, content:String, handler: JsonResponseHandler?) {
...
//        안 읽은 알림 갯수만 가져오는 기능 - 메인화면에서 알림 갯수 표기 용도
        ...
        fun getRequestUnreadNotiCount(context: Context, handler: JsonResponseHandler?) {
